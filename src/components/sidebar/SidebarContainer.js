...
import ECommercePanel from
    "../../interactive-live-streaming/components/ECommercePanel";
import CreatePoll from
    "../../interactive-live-streaming/components/pollContainer/CreatePoll";
import PollList from
    "../../interactive-live-streaming/components/pollContainer/PollList";
import SubmitPollList from
    "../../interactive-live-streaming/components/pollContainer/SubmitPollList";
...
const SideBarTabView = ({
  ...
  style = {
    {
      height, width: sideBarContainerWidth, paddingTop: panelPadding,
          paddingLeft: panelPadding, paddingRight: panelPadding,
          paddingBottom: panelPadding,
          backgroundColor: theme.palette.darkTheme.main,
    }
  } > <Fade in = {sideBarMode}>< div
          style={{
    backgroundColor: theme.palette.darkTheme.slightLighter, height: height,
        ...
        >
          <>
            {sideBarMode && (
              <Box
                style={{
    padding: panelHeaderPadding, height: panelHeaderHeight - 1, display: "flex",
    ...
    ...{ panelHeight, polls, draftPolls, setSideBarMode }}
              ...
              <CreatePoll {
    ...{ panelHeight, polls, setSideBarMode }} />
...
export function SidebarConatiner({
  ...
  / /
      console.log("sidebarMode", sideBarMode, "isMobile", isMobile, "isTab",
                  isTab)

  return sideBarMode ? (isTab || isMobile ? (< Dialog
  closeAfterTransition
  fullScreen
  open = {sideBarMode} onClose = {
      handleClose} TransitionComponent = {Transition} > < SideBarTabView
          height={"100%"}
